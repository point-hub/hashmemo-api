...
export const schema: ISchema[] = [
  {
    ...
    schema: {
      ...
      properties: {
        ...
        code: {
          bsonType: 'string',
          description: 'The code of the file entity.',
        },
        name: {
          bsonType: 'string',
        ...
        composite_unique_1: {
          bsonType: 'string',
          description: 'The composite_unique_1 of the file entity.',
        },
        composite_unique_2: {
          bsonType: 'string',
          description: 'The composite_unique_2 of the file entity.',
        },
        optional_unique: {
          bsonType: 'string',
          description: 'The optional_unique of the file entity.',
        },
        optional_composite_unique_1: {
          bsonType: 'string',
          description: 'The optional_composite_unique_1 of the file entity.',
        },
        optional_composite_unique_2: {
          bsonType: 'string',
          description: 'The optional_composite_unique_2 of the file entity.',
        },
        xxx_composite_unique_1: {
          bsonType: 'string',
          description: 'The xxx_composite_unique_1 of the file entity.',
        },
        xxx_composite_unique_2: {
          bsonType: 'string',
          description: 'The xxx_composite_unique_2 of the file entity.',
        },
        age: {
          bsonType: 'number',
          description: 'The age value associated with the file entity.',
        },
        gender: {
          bsonType: 'string',
          description: 'The gender associated with the file entity.',
        },
        notes: {
          bsonType: 'string',
          description: 'Additional notes or information about the file entity.',
        },
        is_archived: {
          bsonType: 'bool',
