...
import { VoidUseCase } from '../use-cases/void.use-case';

export const voidController: IController = async (controllerInput: IControllerInput) => {
  let session;
  try {
    ...
    const response = await voidUseCase.handle({
