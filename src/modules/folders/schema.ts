...
export const schema: ISchema[] = [
  {
    ...
    schema: {
      ...
      properties: {
        ...
        code: {
          bsonType: 'string',
          description: 'The code of the folder entity.',
        },
        name: {
          bsonType: 'string',
          description: 'The name of the folder entity.',
        },
        composite_unique_1: {
          bsonType: 'string',
          description: 'The composite_unique_1 of the folder entity.',
        },
        composite_unique_2: {
          bsonType: 'string',
          description: 'The composite_unique_2 of the folder entity.',
        },
        optional_unique: {
          bsonType: 'string',
          description: 'The optional_unique of the folder entity.',
        },
        optional_composite_unique_1: {
          bsonType: 'string',
          description: 'The optional_composite_unique_1 of the folder entity.',
        },
        optional_composite_unique_2: {
          bsonType: 'string',
          description: 'The optional_composite_unique_2 of the folder entity.',
        },
        xxx_composite_unique_1: {
          bsonType: 'string',
          description: 'The xxx_composite_unique_1 of the folder entity.',
        },
        xxx_composite_unique_2: {
          bsonType: 'string',
          description: 'The xxx_composite_unique_2 of the folder entity.',
        },
        age: {
          bsonType: 'number',
          description: 'The age value associated with the folder entity.',
        },
        gender: {
          bsonType: 'string',
          description: 'The gender associated with the folder entity.',
        },
        notes: {
          bsonType: 'string',
          description: 'Additional notes or information about the folder entity.',
        },
        is_archived: {
          bsonType: 'bool',
